  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-screen h-screen bg-gray-900 overflow-hidden">
        ...
        >
          Hey guys, this is a micro-gig platform created by team VOID. This platform can be used to create micro-gigs and users can also accept gigs of other users. The payouts can be decided through mutual communication.
          <br />
          Enjoy your surf! 🏄‍♂️
        </motion.p>
        <motion.button
