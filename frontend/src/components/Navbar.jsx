...
export default function Navbar({ setActiveTab, activeTab }) {
  ...
  return (
    <>
      <div className="grid grid-col-6 grid-flow-col w-full fixed p-2 bg-gray-900 z-30">
        {/* gigs */}
        <div className="col-start-2 col-span-4 flex justify-evenly bg-gray-800 rounded-2xl">
          ...
          >
            <div className={handleColor1}>All Gigs</div>
          </motion.button>
          <motion.button
          ...
          >
            <div className={handleColor2}>My Gigs</div>
          </motion.button>
          <motion.button
            initial={{ y: -200, opacity: 0 }}
            whileHover={{ scale: 1.1 }}
          ...
          >
            <div className={handleColor3}>Created Gigs</div>
          </motion.button>
          <motion.button
            initial={{ x: 200, opacity: 0 }}
            whileHover={{ scale: 1.1 }}
          ...
          >
            <div className={handleColor4}>Completed</div>
          </motion.button>
        </div>
        {/* util */}
